...
numeroUsuario = int(input("Digite un numero para hacer la recursividad: "))
imprimir_numeros_recursivos(numeroUsuario) # Tarea: que el numero lo ingrese el usuario