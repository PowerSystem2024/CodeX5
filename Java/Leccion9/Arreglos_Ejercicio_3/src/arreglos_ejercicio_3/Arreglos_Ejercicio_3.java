/*
Ejercicio 3: Leer 5 números por teclado, almacenarios en un arreglo 
y a continuación realizar la media de los
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (conteo_negativos == 0) {
                ...
                System.out.println("La media de los numeros negativos");
            }
